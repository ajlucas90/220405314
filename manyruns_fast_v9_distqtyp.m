function [qi,Pqi] = manyruns_fast_v9_distqtyp(N,M,mu,sigmarel,Jrel,arel,b,kappa,Nt,sellernoise,numruns)

[qi, Pqi] = one_run(N,M,mu,sigmarel,Jrel,arel,b,kappa,Nt,sellernoise);
...
for j=2:numruns
    ...
    kappa
    j
    [qi, temp] = one_run(N,M,mu,sigmarel,Jrel,arel,b,kappa,Nt,sellernoise);
    Pqi = Pqi + temp;
end
...
function [qi,Pqi] = one_run(N,M,mu,sigma,Jrel,arel,b,kappa,Nt,sellernoise)
