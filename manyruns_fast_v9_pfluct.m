function [deltap] = manyruns_fast_v9_pfluct(N,M,mu,sigmarel,Jrel,arel,b,kappa,Nt,sellernoise,numruns)

deltap = zeros(numruns,1);
...
for j=1:numruns
    ...
    kappa
    j
    [deltap(j)] = one_run(N,M,mu,sigmarel,Jrel,arel,b,kappa,Nt,sellernoise);
end

end

function [deltap] = one_run(N,M,mu,sigma,Jrel,arel,b,kappa,Nt,sellernoise)
